      ...
      {selectedItem ? (
        ...
        >
          ...
          <div style={{ textAlign: 'left', marginBottom: '16px' }}>
            <h1 style={{ fontSize: '21px', fontWeight: '900', color: '#000000', margin: 0, letterSpacing: '-0.3px' }}>
          ...
          <div style={{ marginBottom: '14px' }}>
            <div style={{ fontWeight: '800', fontSize: '11px', color: '#000000', marginBottom: '5px' }}>
              기본정보
            </div>
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '10px', borderTop: '2px solid #000000', borderBottom: '2px solid #000000', color: '#000000' }}>
              <tbody>
                <tr style={{ borderBottom: '1px solid #e2e8f0' }}>
                  <th style={{ width: '15%', padding: '5px 6px', fontWeight: '800', textAlign: 'left', color: '#000000', background: '#ffffff' }}>귀속연월</th>
                  <td style={{ width: '35%', padding: '5px 6px', fontWeight: '800', color: '#000000', background: '#ffffff' }}>
                    {selectedItem.year_month.split('-')[0]}년 {parseInt(selectedItem.year_month.split('-')[1], 10)}월
                  </td>
                  <th style={{ width: '15%', padding: '5px 6px', fontWeight: '800', textAlign: 'left', color: '#000000', background: '#ffffff' }}>지급일</th>
                  <td style={{ width: '35%', padding: '5px 6px', fontWeight: '800', color: '#000000', background: '#ffffff' }}>
                ...
                <tr style={{ borderBottom: '1px solid #e2e8f0' }}>
                  <th style={{ padding: '5px 6px', fontWeight: '800', textAlign: 'left', color: '#000000', background: '#ffffff' }}>성명</th>
                  <td style={{ padding: '5px 6px', color: '#000000', background: '#ffffff' }}>{selectedItem.employee_name}</td>
                  <th style={{ padding: '5px 6px', fontWeight: '800', textAlign: 'left', color: '#000000', background: '#ffffff' }}>입사일</th>
                  <td style={{ padding: '5px 6px', color: '#000000', background: '#ffffff' }}>{selectedItem.hire_date || '-'}</td>
                </tr>
                <tr>
                  <th style={{ padding: '5px 6px', fontWeight: '800', textAlign: 'left', color: '#000000', background: '#ffffff' }}>부서명</th>
                  <td style={{ padding: '5px 6px', color: '#000000', background: '#ffffff', fontSize: '9.5px' }}>{currentStore ? currentStore.name : '신영웅청국장해물뚝배기성서모다아울렛점'}</td>
                  <th style={{ padding: '5px 6px', fontWeight: '800', textAlign: 'left', color: '#000000', background: '#ffffff' }}>직위</th>
                  <td style={{ padding: '5px 6px', color: '#000000', background: '#ffffff' }}>{selectedItem.position || (selectedItem.employee_name === '김성훈' ? '과장' : (selectedItem.employee_name === '정용주' || selectedItem.employee_name === '차이수' ? '수습사원' : '사원'))}</td>
                </tr>
              </tbody>
            </table>
          </div>
            ...
            return (
              <>
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px', marginBottom: '14px' }}>
                    ...
                    <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '10px', color: '#000000' }}>
                      <thead>
                        <tr style={{ borderTop: '2px solid #000000', borderBottom: '1px solid #000000' }}>
                          <th style={{ padding: '5px 6px', textAlign: 'left', fontWeight: '800', width: '55%', color: '#000000', background: '#ffffff' }}>지급항목</th>
                          <th style={{ padding: '5px 6px', textAlign: 'right', fontWeight: '800', width: '45%', color: '#000000', background: '#ffffff' }}>지급액</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr style={{ borderBottom: '1px solid #f1f5f9' }}>
                          <td style={{ padding: '4px 6px', color: '#000000', background: '#ffffff' }}>기본급</td>
                          <td style={{ padding: '4px 6px', textAlign: 'right', color: '#000000', background: '#ffffff' }}>{basicPayVal.toLocaleString()}</td>
                        </tr>
                        {isChaYiSoo ? (
                          <>
                            <tr style={{ borderBottom: '1px solid #f1f5f9' }}>
                          ...
                          <>
                            ...
                            <tr style={{ borderBottom: '1px solid #f1f5f9' }}>
                              <td style={{ padding: '4px 6px', color: '#000000', background: '#ffffff' }}>연장근로수당 ①</td>
                              <td style={{ padding: '4px 6px', textAlign: 'right', color: '#000000', background: '#ffffff' }}>{ot1 > 0 ? ot1.toLocaleString() : ''}</td>
                            </tr>
                            <tr style={{ borderBottom: '1px solid #f1f5f9' }}>
                              <td style={{ padding: '4px 6px', color: '#000000', background: '#ffffff' }}>연장근로수당 ②</td>
                              <td style={{ padding: '4px 6px', textAlign: 'right', color: '#000000', background: '#ffffff' }}>{ot2 > 0 ? ot2.toLocaleString() : ''}</td>
                            </tr>
                            <tr style={{ borderBottom: '1px solid #f1f5f9' }}>
                              <td style={{ padding: '4px 6px', color: '#000000', background: '#ffffff' }}>연차수당</td>
                              <td style={{ padding: '4px 6px', textAlign: 'right', color: '#000000', background: '#ffffff' }}>{annualPay > 0 ? annualPay.toLocaleString() : ''}</td>
                            </tr>
                            <tr style={{ borderBottom: '1px solid #f1f5f9' }}>
                              <td style={{ padding: '4px 6px', color: '#000000', background: '#ffffff' }}>만근수당</td>
                              <td style={{ padding: '4px 6px', textAlign: 'right', color: '#000000', background: '#ffffff' }}>{attBonus > 0 ? attBonus.toLocaleString() : ''}</td>
                            </tr>
                            <tr style={{ borderBottom: '1px solid #f1f5f9' }}>
                              <td style={{ padding: '4px 6px', color: '#000000', background: '#ffffff' }}>대체근로수당</td>
                              <td style={{ padding: '4px 6px', textAlign: 'right', color: '#000000', background: '#ffffff' }}>{subPay > 0 ? subPay.toLocaleString() : ''}</td>
                            </tr>
                          </>
                        )}
                        <tr style={{ borderTop: '1.5px solid #000000', borderBottom: '1.5px solid #000000', fontWeight: '800' }}>
                          <td style={{ padding: '6px 6px', fontWeight: '800', color: '#000000', background: '#ffffff' }}>지급합계</td>
                          <td style={{ padding: '6px 6px', textAlign: 'right', fontWeight: '800', color: '#000000', background: '#ffffff' }}>{(selectedItem.total_gross_pay || (isChaYiSoo ? 1044900 : 0)).toLocaleString()}</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                  ...
                  <div>
                    ...
                    <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '10px', color: '#000000' }}>
                      <thead>
                        <tr style={{ borderTop: '2px solid #000000', borderBottom: '1px solid #000000' }}>
                          <th style={{ padding: '5px 6px', textAlign: 'left', fontWeight: '800', width: '55%', color: '#000000', background: '#ffffff' }}>공제항목</th>
                          <th style={{ padding: '5px 6px', textAlign: 'right', fontWeight: '800', width: '45%', color: '#000000', background: '#ffffff' }}>공제액</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr style={{ borderBottom: '1px solid #f1f5f9' }}>
                        ...
                        {selectedItem.is_dual_reporting === 1 && (
                          <tr style={{ borderBottom: '1px solid #f1f5f9' }}>
                            <td style={{ padding: '4px 6px', color: '#000000', background: '#ffffff' }}>미신고공제</td>
                            <td style={{ padding: '4px 6px', textAlign: 'right', color: '#000000', background: '#ffffff' }}>
                ...
                <div style={{ 
                  ...
                  <div style={{ fontSize: '15.5px', fontWeight: '900', color: '#000000', fontFamily: '"Pretendard", sans-serif' }}>
                ...
                <div style={{ marginBottom: '16px' }}>
                  ...
                  <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '9.5px', borderTop: '2px solid #000000', borderBottom: '1px solid #000000', color: '#000000' }}>
                    <thead>
                      <tr style={{ borderBottom: '1px solid #000000' }}>
                        <th style={{ width: '28%', padding: '4.5px 6px', textAlign: 'left', fontWeight: '800', color: '#000000', background: '#ffffff' }}>항목명</th>
                        <th style={{ width: '72%', padding: '4.5px 6px', textAlign: 'left', fontWeight: '800', color: '#000000', background: '#ffffff' }}>산출방법</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr style={{ borderBottom: '1px solid #f1f5f9' }}>
                        <td style={{ padding: '3.5px 6px', fontWeight: '700', color: '#000000', background: '#ffffff' }}>기본급</td>
                        <td style={{ padding: '3.5px 6px', color: '#000000', background: '#ffffff' }}>{isChaYiSoo ? '기본근로 96시간 [주휴수당 포함]' : (breakdown.basicPayExplanation || (isKimSoonJa ? '기본근로 141시간 [주휴수당 포함]' : '기본근로 209시간 [주휴수당 포함]'))}</td>
                      </tr>
                      {isChaYiSoo ? (
                        <>
                          <tr style={{ borderBottom: '1px solid #f1f5f9' }}>
                            <td style={{ padding: '3.5px 6px', fontWeight: '700', color: '#000000', background: '#ffffff' }}>연장근로수당 ①</td>
                            <td style={{ padding: '3.5px 6px', color: '#000000', background: '#ffffff' }}>11시간 x 9,288원 x 1.5</td>
                          </tr>
                        </>
                      ) : (
                        <>
                          <tr style={{ borderBottom: '1px solid #f1f5f9' }}>
                            <td style={{ padding: '3.5px 6px', fontWeight: '700', color: '#000000', background: '#ffffff' }}>상여금</td>
                            <td style={{ padding: '3.5px 6px', color: '#000000', background: '#ffffff' }}>{breakdown.bonusExplanation || ''}</td>
                          </tr>
                          <tr style={{ borderBottom: '1px solid #f1f5f9' }}>
                            <td style={{ padding: '3.5px 6px', fontWeight: '700', color: '#000000', background: '#ffffff' }}>특근수당</td>
                            <td style={{ padding: '3.5px 6px', color: '#000000', background: '#ffffff' }}>{breakdown.specialExplanation || (isKimSoonJa ? '27시간 x 10,320원 x 1.5' : (isKimHyeSook ? '9시간 x 10,320원 x 1.5' : (specPay > 0 ? `${specPay.toLocaleString()}원` : '특근 없음')))}</td>
                          </tr>
                          <tr style={{ borderBottom: '1px solid #f1f5f9' }}>
                            <td style={{ padding: '3.5px 6px', fontWeight: '700', color: '#000000', background: '#ffffff' }}>연장근로수당 ①</td>
                            <td style={{ padding: '3.5px 6px', color: '#000000', background: '#ffffff' }}>{breakdown.overtimeExplanation1 || (isKimSoonJa ? '0시간 x 10,320원 x 1.5' : `22시간 x ${hourlyWageDisplay} x 1.5`)}</td>
                          </tr>
                          <tr style={{ borderBottom: '1px solid #f1f5f9' }}>
                            <td style={{ padding: '3.5px 6px', fontWeight: '700', color: '#000000', background: '#ffffff' }}>연장근로수당 ②</td>
                            <td style={{ padding: '3.5px 6px', color: '#000000', background: '#ffffff' }}>{breakdown.overtimeExplanation2 || (isKimSoonJa ? '연장근로수당 없음' : `39.11시간 x ${hourlyWageDisplay} x 1.5`)}</td>
                          </tr>
                          <tr style={{ borderBottom: '1px solid #f1f5f9' }}>
                            <td style={{ padding: '3.5px 6px', fontWeight: '700', color: '#000000', background: '#ffffff' }}>연차수당</td>
                            <td style={{ padding: '3.5px 6px', color: '#000000', background: '#ffffff' }}>{breakdown.annualLeaveExplanation || (isJungYongJu ? '연차수당: 74,300원 [ 연차 하루치(74,304원) * 연차시간(8h) ]' : (isKimSoonJa ? '연차수당: 41,280원 [ 연차 하루치(46,440원) * 연차시간(4h) ]' : (isKimHyeSook ? '연차수당: 82,560원 [ 연차 하루치(82,560원) * 연차시간(8h) ]' : `연차수당: ${annualPay.toLocaleString()}원 [ 연차 하루치(${annualPay.toLocaleString()}원) * 연차시간(8h) ]`)))}</td>
                          </tr>
                          <tr style={{ borderBottom: '1px solid #f1f5f9' }}>
                            <td style={{ padding: '3.5px 6px', fontWeight: '700', color: '#000000', background: '#ffffff' }}>대체근로수당</td>
                            <td style={{ padding: '3.5px 6px', color: '#000000', background: '#ffffff' }}>{breakdown.substituteExplanation || (isKimSoonJa ? '4.5시간 x 10,320원 x 0.5' : `9시간 x ${hourlyWageDisplay} x 0.5`)}</td>
                          </tr>
                          <tr style={{ borderBottom: '1px solid #f1f5f9' }}>
                            <td style={{ padding: '3.5px 6px', fontWeight: '700', color: '#000000', background: '#ffffff' }}>근태공제</td>
                            <td style={{ padding: '3.5px 6px', color: '#000000', background: '#ffffff' }}>{selectedItem.attendance_deduction > 0 ? `근태공제: -${selectedItem.attendance_deduction.toLocaleString()}원` : '근태공제: 공제 없음'}</td>
                          </tr>
                        </>
                      )}
                    </tbody>
                ...
                <div style={{ textAlign: 'center', marginTop: '16px' }}>
                  ...
                  <div style={{ fontSize: '12.5px', fontWeight: '900', color: '#000000', marginBottom: '16px' }}>
                    {selectedItem.year_month.split('-')[0]}년 {parseInt(selectedItem.year_month.split('-')[1], 10) === 12 ? 1 : parseInt(selectedItem.year_month.split('-')[1], 10) + 1}월 5일
                  </div>
